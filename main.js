...
/* Posição do rover no canvas */
roverX = 10;
roverY = 10;

/* função add: Adicionar a imagem de fundo e do rover  */
function add() 
{
...
/* função uploadBackground: é chamada para enviar a imagem de fundo  */
function uploadBackground() {
	ctx.drawImage(backgroundImgTag, 0, 0, canvas.width, canvas.height);
}

/* função uploadrover: é chamada para enviar a imagem do rover  */
